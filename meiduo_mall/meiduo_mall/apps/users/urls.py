...
urlpatterns = [
    ...
    url(r'authorizations/$', obtain_jwt_token),# 登陆 获取JWT token
    ...
    url(r'^user/$', views.UserDetailSerializer.as_view()),  # 用户个人中心数据
    url(r'^emails/$', views.EmailView.as_view()),  # 发送邮件
    url(r'^emails/verification/$', views.EmailVerifyView.as_view()),  # 发送邮件
